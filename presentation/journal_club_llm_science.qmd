...
2. Use GPT-3.5turbo to rewrite those abstracts to get LLM token distribution
...
|--------|--------|-----------|
| Book citations | +11.9% overall | More books |
...
### Natural experiment: Bing Chat launch (Feb 2023)
...
1. **No causal identification** --- observational study; adoption is non-random and may be endogenous to productivity
